...
pub struct StdVar(Rc<RefCell<StandardVariable>>);
...
impl ExprVariable for StdVar {}

impl_expr_display!(StdVar);
impl_expr_ops!(StdVar, [f64, f32, i8, i16, i32, i64, i128, isize]);
